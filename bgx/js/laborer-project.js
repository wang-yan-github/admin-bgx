var loadAddress = costomUrl + 'getworkerprojectlist?token=' + customSession.data.token;
var modalAuditFormAddress = costomUrl + 'changeworkerproject?token=' + customSession.data.token;
var modalDetailFormAddress = costomUrl + 'getworkerprojectdetail?token=' + customSession.data.token;
