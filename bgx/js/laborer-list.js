var loadAddress = 'https://bgx.lingser.cn/getworkerlist?token=' + customSession.data.token;
var modalAuditFormAddress = 'https://bgx.lingser.cn/auditworker?token=' + customSession.data.token;
var modalDetailFormAddress = 'https://bgx.lingser.cn/getworkerdetail?token=' + customSession.data.token;
        ...
        columns: [
            ...
            },
            {
                ...
                formatter: function (value, row, index) {
                    var res = '<button class="btn btn-outline btn-info btn-xs" onclick="getDetail(\'' + row.w_id + '\')">详情</button>';
                    if(row.w_status == 101){
                        res += '&nbsp;&nbsp;&nbsp;&nbsp;<button class="btn btn-outline btn-success btn-xs" onclick="getAudit(\'' + row.w_id + '\')">审核</button>';
                    }
...
function htmlyj(value,index,parent) {
    var html = '                   <div class="panel panel-default">\n' +
        ...
        '                                    <a data-toggle="collapse" data-parent="#' + parent + '" href="#collapse' + index + '"><i class="fa fa-info-circle">&nbsp;&nbsp;&nbsp;&nbsp;劳务项目业绩 ' + index + '</i></a>\n' +
        '                                </h5>\n' +
        '                            </div>\n' +
